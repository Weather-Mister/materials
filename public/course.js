    ...
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          html: "<p>The lecture states that electrons occupy <strong>discrete energy levels</strong> in an atom. As the number of bonded atoms increases, the energy levels of valence electrons split into many closely spaced levels; in a solid these form energy bands.</p><div class='sourceStrip'><span>Study the professor's original band-formation diagram.</span><b>Slide 18 · energy levels broaden into bands as atoms are grouped</b></div>",
        ...
        },
        {
          ...
          html: "<p>According to the lecture, metallic bonding leads to:</p><ul class='lessonList'><li><strong>Good conductivity:</strong> electrons are not fixed in place.</li><li><strong>Good ductility:</strong> metallic bonds are non-directional.</li><li><strong>High melting points</strong> and electropositive behavior, with susceptibility to corrosion or oxidation noted in the lecture.</li></ul><p>The textbook figure used on slide 23 shows positively charged atom cores immersed in mobile valence electrons.</p>",
